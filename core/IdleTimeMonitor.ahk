...
class IdleTimeMonitor {
    ...
    Start() {
        ...
        this.StartingTimeStamp := A_TickCount
        this.CurrentIdleTime := 0

        this.monitorTask.Start()
        this.running := true
        DebugLog A_ThisFunc, "开始运行闲置检测服务"
        DebugLog A_ThisFunc, "StartingTimeStamp: " this.StartingTimeStamp
    }
    ...
    MonitorTaskRoutine() {
        ...
        ; 更新闲置时间
        this.CurrentIdleTime := (A_TickCount - this.StartingTimeStamp) / 1000 / 60
